...
$civicrm_paths['civicrm.files']['url'] = 'https://bloop.ddev.site//sites/default/files/civicrm';
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://bloop.ddev.site');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'UHq9immHocXLW02rDP1Q34lby4FBjMNDwu8teatT7E');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:mdDh7yJw0k1nUq52n9rks4QLPz5txrdkDtQI4v9BxWAhUnucTw');
...
if (!defined('CIVICRM_DEPLOY_ID') ) {
  define( '_CIVICRM_DEPLOY_ID', '6ZDVfMuGp0R4Sg');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:xjSR4LfPdtlf5oymBR6f6kPYHSWT0pFxwHhvNYWBe4OLgjcm1ADRg');
